<template>
    <div>
        ...
        <Head>
            <title>Absensi Siswa - Aplikasi Ujian Online</title>
        </Head>
        ...
        <div class="card">
            <div class="card-title text-center fw-bold">
                <h3 class="mt-2">Absensi Siswa</h3>
            </div>
            <div class="card-body text-center">
                ...
                <p>Klik tombol di bawah ini untuk melakukan absensi atas nama <span class="fw-bold">{{ auth.student.name
                        }}</span></p>
                <div class="mb-3">
...
export default defineComponent({
    ...
    methods: {
        ...
        async checkAbsensiToday() {
            try {
                const response = await axios.get('/student/check-absensi-today');
        ...
        absenMasuk() {
            axios.post('/student/presence-submit', {

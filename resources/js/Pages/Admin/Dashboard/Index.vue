                            ...
                            <div
                                ...
                                <div class="icon-shape icon-shape-warning rounded me-4 me-sm-0">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                        class="bi bi-building icon icon-md" viewBox="0 0 16 16">
                                        <path
                        ...
                        <div class="row d-block d-xl-flex align-items-center">
                            <div
                                ...
                                <div class="icon-shape icon-shape-info rounded me-4 me-sm-0">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                        class="bi bi-back icon icon-md" viewBox="0 0 16 16">
                                        <path
                        ...
                        <div class="row d-block d-xl-flex align-items-center">
                            <div
                                ...
                                <div class="icon-shape icon-shape-success rounded me-4 me-sm-0">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                        class="bi bi-people-fill icon icon-md" viewBox="0 0 16 16">
                                        <path
                        ...
                        <div class="row d-block d-xl-flex align-items-center">
                            <div
                                ...
                                <div class="icon-shape icon-shape-tertiary rounded me-4 me-sm-0">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                        class="bi bi-pencil-square icon icon-md" viewBox="0 0 16 16">
                                        <path
                        ...
                        <div class="row d-block d-xl-flex align-items-center">
                            <div
                                ...
                                <div class="icon-shape icon-shape-danger rounded me-4 me-sm-0">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                        class="bi bi-stopwatch icon icon-md" viewBox="0 0 16 16">
                                        <path

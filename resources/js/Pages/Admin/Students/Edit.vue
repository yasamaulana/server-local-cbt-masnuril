                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select" v-model="form.ketua_kelas">
                                            <option value="2">Iya</option>
                                            <option value="1">Tidak</option>
                                        </select>
                                        <div v-if="errors.ketua_kelas" class="alert alert-danger mt-2">
                                            {{ errors.ketua_kelas }}
                                        </div>
                                    </div>
                                </div>
    ...
    export default {
        ...
        setup(props) {
            ...
            const form = reactive({
                ...
                ketua_kelas: props.student.ketua_kelas,

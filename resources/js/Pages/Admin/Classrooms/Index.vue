            ...
            <div class="col-md-8">
                <div class="row">
                    <div class="col-md-3 col-12 mb-2">
                        <Link href="/admin/classrooms/create" class="btn btn-md btn-primary border-0 shadow w-100"
                            ...
                            <table class="table table-bordered table-centered table-nowrap mb-0 rounded">
                                ...
                                <tbody>
                                    <tr v-for="(classroom, index) in classrooms.data" :key="index">
                                        <td class="fw-bold text-center">{{ ++index + (classrooms.current_page - 1) *
                                            classrooms.per_page }}</td>
                                        <td>{{ classroom.id }}</td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <button @click.prevent="destroy(classroom.id)"

<template>
    <Head>
        <title>Tambah Struktur Organisasi - Aplikasi Ujian Online</title>
    </Head>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card border-0 shadow">
                    <div class="card-body">
                        <h5><i class="fa fa-user"></i> Tambah struktur-organisasi</h5>
                        <hr>
...
export default {
    ...
    setup() {
        ...
        const submit = () => {
            ...
            Inertia.post('/admin/struktur-organisasi', formData, {
                onSuccess: () => {
                    Swal.fire({
                        title: 'Success!',
                        text: 'struktur-organisasi Berhasil Disimpan.',
                        icon: 'success',

    ...
    <div class="container-fluid mb-5 mt-5">
        <div class="row">
            <div class="col-md-12">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <select class="form-select" v-model="form.exam_id">
                                        <option v-for="(exam, index) in exams" :key="index" :value="exam.id">{{
                                            exam.title }} — Kelas : {{ exam.classroom.title }} — Pelajaran : {{
                                                exam.lesson.title }}</option>
                                    </select>
                ...
                <div v-else="grades.length > 0" class="card border-0 shadow">
                    <div class="card-body">
                        <h5 class="mt-2 text-center"><i class="fa fa-chart-line"></i> Belum ada informasi untuk ujian
                            ini</h5>
                    </div>
                </div>
            </div>

<template>
    ...
    <Head>
        <title>Import Guru - Aplikasi Ujian Online</title>
    </Head>
    <div class="container-fluid mb-5 mt-5">
        <div class="row">
            <div class="col-md-12">
                <Link href="/admin/teachers" class="btn btn-md btn-primary border-0 shadow mb-3 me-3" type="button">
                <i class="fa fa-long-arrow-alt-left me-2"></i> Kembali
                </Link>
                <a href="/assets/excel/teachers.xls" target="_blank"
                ...
                <div class="card border-0 shadow">
                    <div class="card-body">
                        <h5><i class="fa fa-user"></i> Import Guru</h5>
                        <hr>
...
export default {
    ...
    setup() {
        ...
        const submit = () => {
            Inertia.post('/admin/teachers/import', {
                file: form.file,
            }, {
                onSuccess: () => {
                    Swal.fire({
                        title: 'Success!',
                        text: 'Import Guru Berhasil Disimpan!',
                        icon: 'success',
